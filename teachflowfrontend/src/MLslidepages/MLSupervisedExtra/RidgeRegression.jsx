...
const RidgeRegression = () => {
  return (
    <div className="max-w-5xl mx-auto p-6 pt-16 space-y-6">
      <h1 className="text-3xl font-bold mb-4">Ridge Regression</h1>

      <h2 className="text-2xl font-semibold mt-6">What is Ridge Regression?</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold mt-6"> Mathematical Formulation</h2>
...
{`Objective:
   minimize β ( ||y - Xβ||² + λ||β||² )
     Where:
      ...
      <h2 className="text-xl font-semibold mt-6"> Intuition</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold mt-6">Comparison with Other Methods</h2>
  ...
  <table className="min-w-full table-auto border border-collapse border-gray-300 mt-4">
    <thead>
      <tr className="bg-gray-200 text-sm sm:text-base">
        <th className="border px-2 sm:px-4 py-2 text-left">Method</th>
        <th className="border px-2 sm:px-4 py-2 text-left">Penalty</th>
        <th className="border px-2 sm:px-4 py-2 text-left">Can Coefficients Be Zero?</th>
        <th className="border px-2 sm:px-4 py-2 text-left">Use Case</th>
      </tr>
    </thead>
    <tbody className="text-sm sm:text-base">
      <tr>
        <td className="border px-2 sm:px-4 py-2">OLS</td>
        <td className="border px-2 sm:px-4 py-2">None</td>
        <td className="border px-2 sm:px-4 py-2">❌</td>
        <td className="border px-2 sm:px-4 py-2">Simple linear models</td>
      </tr>
      <tr>
        <td className="border px-2 sm:px-4 py-2">Ridge</td>
        <td className="border px-2 sm:px-4 py-2">L2</td>
        <td className="border px-2 sm:px-4 py-2">❌</td>
        <td className="border px-2 sm:px-4 py-2">Multicollinearity</td>
      </tr>
      <tr>
        <td className="border px-2 sm:px-4 py-2">Lasso</td>
        <td className="border px-2 sm:px-4 py-2">L1</td>
        <td className="border px-2 sm:px-4 py-2">✅</td>
        <td className="border px-2 sm:px-4 py-2">Feature selection</td>
      </tr>
      <tr>
        <td className="border px-2 sm:px-4 py-2">ElasticNet</td>
        <td className="border px-2 sm:px-4 py-2">L1 + L2</td>
        <td className="border px-2 sm:px-4 py-2">✅</td>
        <td className="border px-2 sm:px-4 py-2">Mixed Lasso + Ridge</td>
      </tr>
    </tbody>
 </table>
       </div>
      ...
      <h2 className="text-xl font-semibold mt-6"> Python Example (scikit-learn)</h2>
      <pre className="bg-gray-100 p-4 rounded text-sm overflow-x-auto">
...
plt.show()`}
      ...
      <h2 className="text-xl font-semibold mt-6">Advantages</h2>
      <ul className="list-disc ml-6">
      ...
      <h2 className="text-xl font-semibold mt-6"> Disadvantages</h2>
      <ul className="list-disc ml-6">
        <li>Does not perform feature selection</li>
        <li>Requires feature scaling</li>
      </ul>

      <h2 className="text-xl font-semibold mt-6">🔧 Hyperparameter Tuning</h2>
      <pre className="bg-gray-100 p-4 rounded text-sm overflow-x-auto">
      ...
      <table className="table-auto border border-collapse border-gray-300 mt-4">
        <thead>
          <tr className="bg-gray-200">
            ...
            <th className="border px-4 py-2">Ridge Regression</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td className="border px-4 py-2">Type</td>
            <td className="border px-4 py-2">Linear Model with L2 Regularization</td>
          </tr>
          <tr>
            <td className="border px-4 py-2">Goal</td>
            <td className="border px-4 py-2">Reduce overfitting & handle multicollinearity</td>
          </tr>
          <tr>
            <td className="border px-4 py-2">Key Parameter</td>
            <td className="border px-4 py-2">alpha</td>
          </tr>
          <tr>
            <td className="border px-4 py-2">Feature Selection?</td>

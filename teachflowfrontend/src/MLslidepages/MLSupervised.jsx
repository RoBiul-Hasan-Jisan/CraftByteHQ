      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <ul className="list-disc list-inside ml-4">
            ...
            <li onClick={() => goTo("/supervised/decision-tree")} className="text-blue-600 cursor-pointer hover:underline">🔷 Decision Tree Regression</li>
            <li onClick={() => goTo("/supervised/random-forest")} className="text-blue-600 cursor-pointer hover:underline">🔷 Random Forest Regression</li>
            <li onClick={() => goTo("/supervised/svr")} className="text-blue-600 cursor-pointer hover:underline">🔷 Support Vector Regression (SVR)</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p><strong>Algorithms:</strong></p>
          <ul className="list-disc list-inside ml-4">
            <li onClick={() => goTo("/supervised/logistic-regression")} className="text-blue-600 cursor-pointer hover:underline">🔷 Logistic Regression</li>
            <li onClick={() => goTo("/supervised/knn")} className="text-blue-600 cursor-pointer hover:underline">🔷 k-Nearest Neighbors (KNN)</li>
            <li onClick={() => goTo("/supervised/decision-tree")} className="text-blue-600 cursor-pointer hover:underline">🔷 Decision Trees</li>
            <li onClick={() => goTo("/supervised/svm")} className="text-blue-600 cursor-pointer hover:underline">🔷 Support Vector Machines (SVM)</li>
            <li onClick={() => goTo("/supervised/naive-bayes")} className="text-blue-600 cursor-pointer hover:underline">🔷 Naive Bayes</li>
            <li onClick={() => goTo("/supervised/random-forest")} className="text-blue-600 cursor-pointer hover:underline">🔷 Random Forest Classifier</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc list-inside ml-4">
            <li onClick={() => goTo("/supervised/gbm")} className="text-blue-600 cursor-pointer hover:underline">🔷 Gradient Boosting Machines (GBM)</li>
            <li onClick={() => goTo("/supervised/adaboost")} className="text-blue-600 cursor-pointer hover:underline">🔷 AdaBoost</li>
            <li onClick={() => goTo("/supervised/xgboost")} className="text-blue-600 cursor-pointer hover:underline">🔷 XGBoost</li>
            <li onClick={() => goTo("/supervised/lightgbm")} className="text-blue-600 cursor-pointer hover:underline">🔷 LightGBM</li>
            <li onClick={() => goTo("/supervised/catboost")} className="text-blue-600 cursor-pointer hover:underline">🔷 CatBoost</li>
          </ul>
        </div>
      </div>

...
export default function Sidebar() {
  ...
  // If specialized sidebar for path, just return it (you can add toggle logic there too if needed)
  ...
  return (
    <>
      ...
      <button
        className="md:hidden fixed top-1/2 left-2 transform -translate-y-1/2 z-50 bg-blue-500 text-white p-2 rounded-md focus:outline-none"
      ...
      <aside
        className={`
          fixed top-0 left-0 h-full bg-gray-200 p-4 w-64
